...
export const ZILAN_CLOUD_BASE_URL = 'https://weknora.weixin.qq.com'
export const ZILAN_CLOUD_PROVIDER = 'weknoracloud'
...
export function isWeKnoraCloudModel(model: ModelConfig): boolean {
  return model.parameters?.provider === ZILAN_CLOUD_PROVIDER
}
...
export function buildWkcModelConfig(
  ...
  const parameters: ModelConfig['parameters'] = {
    base_url: ZILAN_CLOUD_BASE_URL,
    provider: ZILAN_CLOUD_PROVIDER,
  }
