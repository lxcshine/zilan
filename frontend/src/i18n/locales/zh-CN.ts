export default {
  // ===== 三栏布局 / 模式化导航（PRD ui-layout-visual-redesign）=====
  rail: {
    ariaLabel: "主导航",
    backHome: "回到新对话",
    chat: "问答",
  ...
  panel: {
    ...
    kbDisabled: "已停用",
    builtinTag: "内置",
    filterByStatus: "按解析状态筛选",
    chooseKnowledgeBase: "选择目标知识库",
    statusAll: "全部",
  ...
  quickActions: {
    ...
    webSummary: "网页摘要",
    newKnowledgeBase: "新建知识库",
    webSummaryPrompt: "总结这个网页：",
    writingContinue: "续写",
    writingContinuePrompt: "请续写以下内容：",
    writingPolish: "润色",
    writingPolishPrompt: "请润色以下文字，使其更流畅专业：",
    writingSummarize: "摘要",
    writingSummarizePrompt: "请用要点式总结以下内容：",
    writingTranslate: "翻译",
    writingTranslatePrompt: "请将以下内容翻译为英文：",
  },
  documents: {
    subtitle: "跨知识库的文档资产总览，追踪解析进度与状态",
    totalDocuments: "文档总数",
    recentDocuments: "最近更新",
    backToList: "返回文档列表",
    reparse: "重新解析",
    reparseStarted: "已发起重新解析",
    reparseFailed: "重新解析失败，请稍后再试",
    deleteConfirmTitle: "删除文档",
    deleteConfirmBody: "删除后文档及其索引将不可恢复，确定删除吗？",
    deleteSuccess: "文档已删除",
  ...
  memory: {
    title: "我的记忆",
    subtitle: "已沉淀 {count} 条记忆，将在对话中自动召回",
    switchLabel: "记忆功能",
    switchEnabled: "记忆功能已开启",
    switchDisabled: "记忆功能已关闭",
    ...
    modules: {
      ...
      memory: "记忆流",
      agent: "经验技巧",
      soulDesc: "助手的性格与你的专属指令",
      userDesc: "AI 眼中的你",
      memoryDesc: "全部长期记忆一览",
      agentDesc: "助手沉淀的做事方法",
      countLabel: "{module}共 {count} 条",
      summaryTitle: "含 {n} 条会话摘要",
    },
    soul: {
      personaBadge: "全局人设",
      expand: "展开",
      collapse: "收起",
      adjustmentsTitle: "我的风格指令",
      adjustmentsHint: "直接在对话中告诉助手即可沉淀，例如「以后叫我张工」「回答用要点式」。",
      emptyTitle: "还没有风格指令",
      emptyDescription: "直接告诉助手你的称呼与风格偏好，比如「以后叫我张工，回答简洁一点」，指令会自动沉淀并影响每次回答。",
      cta: "去告诉助手",
    },
    profile: {
      completeness: "档案完整度",
      ...
      emptySection: "暂未沉淀",
      viewInMemory: "在记忆流中查看",
      emptyTitle: "档案还是空的",
      emptyDescription: "多和助手聊聊你的职业、职责与偏好，AI 会自动沉淀为档案，让回答更懂你。",
      cta: "去聊聊我自己",
    },
    agent: {
      skillsTitle: "助手技巧",
      skillsHint: "从你的反馈中提炼的做事方法，会注入每次回答",
      skillsEmptyDescription: "明确告诉助手如何改进（如「先给结论再展开」），被采纳后会沉淀为可复用的技巧。",
      fromFeedback: "来自你的反馈：{content}",
      feedbackTitle: "反馈墙",
      feedbackHint: "你对助手的全部评价，可追溯",
      upgraded: "已升级为技巧",
      pending: "待提炼",
      distillCta: "提炼为技巧",
      feedbackEmpty: "暂无反馈记录",
      emptyTitle: "还没有经验沉淀",
      emptyDescription: "当助手收到你的明确反馈，会把改进方法沉淀为可复用的技巧，把事越做越好。",
    },
    status: {
      active: "生效中",
      done: "已完成",
    ...
    empty: {
      title: "还没有记忆",
      description: "与助手对话时，重要的信息会自动沉淀到这里，供后续对话自动召回。",
      filteredTitle: "没有匹配的记忆",
      filteredDescription: "换个关键词或筛选条件试试。",
      cta: "去发起对话",
    },
    error: {
      title: "加载失败",
      description: "记忆列表加载失败，请稍后重试。",
      retry: "重试",
    },
    notAvailable: {
      title: "记忆服务不可用",
      description: "当前环境未启用记忆服务，请联系管理员检查相关配置。",
    },
    edit: {
      title: "编辑记忆",
      category: "类别",
      categoryHint: "类别由提取时判定，暂不支持修改",
      content: "记忆内容",
      contentPlaceholder: "描述这条记忆",
      contentRequired: "记忆内容不能为空",
      object: "关联对象",
      objectPlaceholder: "选填，如产品名、项目名等",
      importance: "重要性",
      status: "状态",
      due: "截止日期",
      duePlaceholder: "选择日期",
      reembedHint: "保存后系统会重新生成向量，编辑结果将在下一次对话召回时生效。",
      save: "保存",
      success: "记忆已更新",
      failed: "更新失败，请稍后重试",
    },
    ...
    clear: {
      button: "清空记忆",
      title: "清空全部记忆",
      description: "即将删除全部 {count} 条记忆，删除后无法恢复。",
      tip: "此操作会影响所有对话的记忆召回，请谨慎执行。",
      inputPlaceholder: "输入「{word}」以确认",
      confirmWord: "清空记忆",
      confirm: "确认清空",
      cancel: "取消",
      success: "已清空 {count} 条记忆",
      failed: "清空失败，请稍后重试",
    },
  },
  chatHeader: {
  ...
  newUserGuide: {
    ...
    steps: {
      ...
      knowledge: {
        title: "创建你的知识库",
        desc: "知识库是一切的起点：上传文档、网页或 FAQ，知澜 会自动解析并建立索引。点击这里进入知识库。",
      },
      chat: {
        title: "发起智能对话",
  ...
  settings: {
    ...
    roleDenied: {
      ...
      title: "知澜云",
      description: "配置 知澜云 的 APPID 和 APPSECRET 凭证。凭证用于模型服务和文档解析引擎。",
      viewDocs: "查看文档",
    ...
    storage: {
      ...
      configurable: "可配置",
      pathPrefix: "路径前缀（可选）",
      pathPrefixPlaceholder: "如 zilan/images",
      prefixPlaceholder: "如 zilan",
  ...
  auth: {
    ...
    // ---- P0-4 双通道注册/登录 + 验证码体系 ----
    account: "手机号 / 邮箱",
    accountPlaceholder: "输入手机号或邮箱",
    identifierRequired: "请输入手机号或邮箱",
    identifierInvalid: "格式不正确，请输入有效的手机号或邮箱",
    phone: "手机号",
    ...
    registerPasswordPlaceholder: "设置密码（8-32 位，含大小写字母和数字）",
    passwordPolicyHint: "密码需 8-32 位，且同时包含大写字母、小写字母和数字",
    ...
    captcha: {
      title: "人机验证",
      sliderHint: "按住滑块，拖动完成拼图",
      textPlaceholder: "输入图中数字",
      loading: "验证码加载中...",
      loadFailed: "验证码加载失败",
      retry: "重试",
      refresh: "换一张",
      passed: "验证通过",
      passedHint: "人机验证已通过",
      failedHint: "验证未通过，请重试",
      required: "请先完成人机验证",
    },
    verification: {
      send: "获取验证码",
      resendIn: "{seconds}s 后重发",
      smsSent: "验证码已发送，请查收短信",
      ...
      codeMismatch: "验证码错误，请检查后重试",
      tooManyAttempts: "错误次数过多，请重新获取验证码",
      invalidTarget: "手机号或邮箱格式不正确",
      channelDisabled: "验证码通道未配置，请联系管理员",
      resendTooFrequent: "发送过于频繁，请稍后再试",
      dailyLimit: "已达当日发送上限，请明天再试",
  ...
  system: {
    ...
    retry: "重试",
    versionLabel: "应用版本",
    versionDescription: "当前应用服务（zilan-app）的版本号",
    frontendVersionLabel: "UI 版本",
    frontendVersionDescription: "当前 UI 界面（zilan-ui）的构建版本号",
    ...
    globalSettings: {
      ...
      backup: {
        tabLabel: "备份与恢复",
        description:
          "用户数据的每日自动快照与恢复：元数据逐空间逻辑导出、文件层对象复制，恢复前逐项校验完整性。仅系统管理员可见。",
        loading: "加载中...",
        retry: "重试",
        loadFailed: "加载备份记录失败",
        disabledTitle: "备份子系统未启用",
        disabledMessage:
          "当前部署未开启备份（WEKNORA_BACKUP_ENABLED=false）。启用后此页面将展示备份状态、记录与恢复入口。",
        never: "从未备份",
        lastSuccess: "上次成功备份",
        rpoCountdown: "下次计划备份",
        rpoIn: "约 {hours} 小时后（每日 03:00）",
        rpoOverdue: "已超出预期窗口",
        retentionPolicy: "保留策略",
        retentionPolicyValue: "日备 {d} 天 / 周备 {w} 周 / 月备 {m} 月",
        runNow: "立即备份",
        runSuccess: "备份完成",
        runFailed: "备份失败",
        deleteConfirm: "删除该快照及其全部存储对象？此操作不可撤销。",
        deleteSuccess: "快照已删除",
        deleteFailed: "删除失败",
        status: {
          running: "进行中",
        ...
        records: {
          title: "备份记录",
          empty: "暂无备份记录。可点击上方「立即备份」创建第一个快照。",
          filterAll: "全部状态",
          snapshot: "快照",
          statusCol: "状态",
          triggerCol: "来源",
        ...
        export: {
          title: "按空间导出",
          hint:
            "将单个空间的元数据与全部文件打包为 tar.gz 归档下载，可用于迁移到其他实例或合规留存。",
          tenantId: "空间 ID",
          download: "导出归档",
          success: "导出已开始下载",
          failed: "导出失败",
        ...
        restore: {
          action: "恢复",
          title: "恢复向导",
          description: "从快照恢复数据。恢复前将逐项校验 SHA-256 完整性，任何损坏都会中止并明示受损条目。",
          stepScope: "第一步：恢复范围",
          scopeTenant: "按空间恢复（推荐，只影响所选空间）",
          scopeInstance: "全实例恢复（灾难恢复，影响所有空间）",
          stepTenant: "第二步：空间与冲突策略",
          modeNew: "恢复为新空间（原名加 -restored- 后缀，最安全）",
          modeOverwrite: "覆盖目标空间（先清空后导入）",
          modeNote: "「恢复为新空间」不会改动现有空间的数据；「覆盖」会先删除目标空间的现有数据。",
          dryRun: "试运行校验",
          dryRunTitle: "试运行报告",
          wouldRows: "将恢复行数",
          wouldFiles: "将恢复文件数",
          execute: "执行恢复",
          executeConfirm: "确认执行恢复？该操作会写入数据库与文件存储。",
          overwriteConfirm: "覆盖模式会先清空目标空间的现有数据，确认执行？",
          progressTitle: "恢复进度",
          rowsRestored: "已恢复 {n} 行",
          filesRestored: "已写回 {n} 个文件",
          rowsSkipped: "跳过冲突 {n} 行",
          reindexQueued: "排队重建索引 {n} 项",
          newTenant: "新空间 ID：{id}",
          success: "恢复完成",
          failed: "恢复失败",
        },
  ...
  embedPublish: {
    ...
    webhookUrlDesc: "可选。访客发消息与助手回复完成时，知澜 会向该 HTTPS 地址 POST 事件（message_sent / message_received）。",
    webhookSecret: "Webhook 签名密钥",
    webhookSecretPlaceholder: "用于 HMAC-SHA256 签名（X-Zilan-Signature）",
  ...
  integrations: {
    ...
    api: {
      ...
      capabilityManageKbsHint: "允许管理知识库全生命周期：新建、复制、修改、删除知识库并调整初始化/配置信息。针对已有知识库的操作（复制/更新/删除）仍受所选知识库范围限制；新建不受限（新知识库归本空间）。",
	      ...
	      capabilityManageModelsHint: "允许管理模型配置、模型凭据、模型连通性测试和 知澜云 凭据。",
      ...
      signedFlowDetail:
        "HMAC 密钥仅保存在 知澜 与你的可信后端，切勿放入请求或下发给浏览器。请求头里传的是用该密钥签出的 JWT 字符串（每次签发或过期后会变），不是密钥本身。JWT 须包含 sub（外部用户 ID）、tenant_id、aud=zilan、exp（有效期不超过 24 小时）。",
      ...
      hmacSecret: "HMAC 密钥",
      hmacSecretDesc: "与 知澜 保存的同一份密钥；仅用于后端签发 JWT，不要作为请求头发送。",
      ...
      signedRequestStep0:
        "# 0. 在你的后端签发 JWT（HS256，aud=zilan，sub=用户 ID，tenant_id={tenantId}，exp 不超过 24 小时）",
    ...
    chrome: {
      title: "知识管理助手",
      subtitle:
        "配合 知澜 自建服务使用：在任意网页侧边栏提问、剪藏内容、Markdown 速记，将浏览中的知识沉淀到你的知识库。",
      ...
      steps: {
        ...
        port: {
          title: "桌面版配置固定端口（推荐）",
          desc: "使用 知澜 桌面版时，在 API 信息中设置固定端口（如 37841），避免每次启动后地址变化导致插件断连。",
        },
        install: {
          title: "安装 Chrome 插件",
    ...
    claw: {
      title: "知澜 Skill",
      subtitle:
        "通过 知澜 REST API 导入文档并执行混合检索（向量 + 关键词）。适用于上传文件/URL/Markdown 到知识库、跨库检索与浏览知识内容。",
      ...
      steps: {
        ...
        env: {
          title: "配置环境变量",
          desc: "在终端或 ~/.zshrc、~/.bashrc 中设置 ZILAN_BASE_URL 与 ZILAN_API_KEY。下方示例已填入当前 API 地址，请将 API Key 替换为实际值。",
        },
        install: {
          title: "安装 Skill",
      ...
      installCtaHint: "安装 知澜 Skill · 将在新标签页打开",
