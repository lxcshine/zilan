export default {
  // ===== 3단 레이아웃 / 모드 내비게이션 (PRD ui-layout-visual-redesign) =====
  rail: {
    ariaLabel: "기본 내비게이션",
    backHome: "새 대화로",
    chat: "대화",
  ...
  panel: {
    historySessions: "기록",
    searchSessions: "대화 제목 검색",
    searchKnowledgeBases: "지식베이스 검색",
    searchAgents: "에이전트 검색",
    newKnowledgeBase: "새 지식베이스",
    uploadDocument: "문서 업로드",
    newAgent: "새 에이전트",
    noSearchResults: "일치하는 결과가 없습니다",
    noKnowledgeBases: "지식베이스가 없습니다",
    noAgents: "에이전트가 없습니다",
    ...
    kbDisabled: "비활성화됨",
    builtinTag: "내장",
    filterByStatus: "파싱 상태로 필터",
    chooseKnowledgeBase: "대상 지식베이스 선택",
    statusAll: "전체",
    statusProcessing: "파싱 중",
    statusCompleted: "완료",
    statusFailed: "실패",
    memorySoul: "소울",
    memoryProfile: "사용자 프로필",
    memoryStream: "기억 스트림",
    memoryTips: "팁과 스킬",
  },
  hero: {
  ...
  quickActions: {
    ...
    webSummary: "웹 요약",
    newKnowledgeBase: "새 지식베이스",
    webSummaryPrompt: "이 웹페이지를 요약해 줘: ",
    writingContinue: "이어쓰기",
    writingContinuePrompt: "다음 내용을 이어서 작성해 줘: ",
    writingPolish: "다듬기",
    writingPolishPrompt: "다음 글을 더 매끄럽고 전문적으로 다듬어 줘: ",
    writingSummarize: "요약",
    writingSummarizePrompt: "다음 내용을 항목식으로 요약해 줘: ",
    writingTranslate: "번역",
    writingTranslatePrompt: "다음 내용을 영어로 번역해 줘: ",
  },
  documents: {
    subtitle: "지식베이스 전체의 문서 자산 현황과 파싱 진행 상황",
    totalDocuments: "문서 총계",
    recentDocuments: "최근 업데이트",
    backToList: "문서 목록으로",
    reparse: "다시 파싱",
    reparseStarted: "재파싱이 시작되었습니다",
    reparseFailed: "재파싱을 시작하지 못했습니다. 잠시 후 다시 시도해 주세요",
    deleteConfirmTitle: "문서 삭제",
    deleteConfirmBody: "삭제 후 문서와 인덱스는 복구할 수 없습니다. 삭제하시겠습니까?",
  ...
  memory: {
    title: "내 기억",
    subtitle: "{count}개의 기억이 저장되어 있으며 대화에서 자동으로 회상됩니다",
    switchLabel: "기억 기능",
    switchEnabled: "기억 기능이 켜졌습니다",
    switchDisabled: "기억 기능이 꺼졌습니다",
    ...
    modules: {
      ...
      memory: "기억 스트림",
      agent: "경험 노하우",
      soulDesc: "어시스턴트 성격과 나만의 지시",
      userDesc: "AI가 보는 나",
      memoryDesc: "모든 장기 기억",
      agentDesc: "어시스턴트가 쌓은 노하우",
      countLabel: "{module} {count}건",
      summaryTitle: "세션 요약 {n}건 포함",
    },
    soul: {
      personaBadge: "전역 페르소나",
      expand: "펼치기",
      collapse: "접기",
      adjustmentsTitle: "내 스타일 지시",
      adjustmentsHint: "대화에서 바로 말하면 됩니다. 예: \"앞으로 장 공정이라고 불러 줘\", \"요점식으로 답해 줘\".",
      emptyTitle: "아직 스타일 지시가 없습니다",
      emptyDescription: "호칭이나 스타일 선호를 어시스턴트에게 말하면 자동으로 기록되어 모든 답변에 반영됩니다.",
      cta: "어시스턴트에게 말하기",
    },
    profile: {
      ...
      emptySection: "아직 없습니다",
      viewInMemory: "기억 스트림에서 보기",
      emptyTitle: "프로필이 비어 있습니다",
      emptyDescription: "직업과 업무, 선호에 대해 이야기하면 AI가 자동으로 프로필을 채워 나갑니다.",
      cta: "대화 시작하기",
    },
    agent: {
      skillsTitle: "어시스턴트 노하우",
      skillsHint: "피드백에서 추려낸 방법이 매 답변에 반영됩니다",
      skillsEmptyDescription: "어떻게 개선할지 명확히 말하면(예: \"결론부터\") 반영되어 재사용 가능한 노하우가 됩니다.",
      fromFeedback: "내 피드백에서: {content}",
      feedbackTitle: "피드백 벽",
      feedbackHint: "남긴 모든 평가를 추적할 수 있습니다",
      upgraded: "노하우로 전환됨",
      pending: "전환 대기",
      distillCta: "노하우로 전환",
      feedbackEmpty: "피드백이 없습니다",
      emptyTitle: "아직 경험이 없습니다",
      emptyDescription: "명확한 피드백을 받으면 개선 방법을 재사용 가능한 노하우로 쌓아 갑니다.",
    },
    status: {
      active: "활성",
      done: "완료",
    ...
    empty: {
      title: "아직 기억이 없습니다",
      description: "대화 중 중요한 정보는 여기에 자동으로 저장되어 이후 대화에서 회상됩니다.",
      filteredTitle: "일치하는 기억이 없습니다",
      filteredDescription: "다른 키워드나 필터로 시도해 보세요.",
      cta: "대화 시작하기",
    },
    error: {
      title: "로드 실패",
      description: "기억 목록을 불러오지 못했습니다. 잠시 후 다시 시도해 주세요.",
      retry: "재시도",
    },
    notAvailable: {
      title: "기억 서비스를 사용할 수 없음",
      description: "현재 환경에서는 기억 서비스가 활성화되어 있지 않습니다. 관리자에게 문의해 주세요.",
    },
    edit: {
      title: "기억 편집",
      category: "분류",
      categoryHint: "분류는 추출 시 결정되며 변경할 수 없습니다",
      content: "내용",
      contentPlaceholder: "이 기억을 설명해 주세요",
      contentRequired: "내용을 입력해 주세요",
      object: "관련 객체",
      objectPlaceholder: "선택 사항, 예: 제품명·프로젝트명",
      importance: "중요도",
      status: "상태",
      due: "기한",
      duePlaceholder: "날짜 선택",
      reembedHint: "저장 후 시스템이 임베딩을 다시 생성하며, 다음 회상부터 수정 사항이 적용됩니다.",
      save: "저장",
      success: "기억이 업데이트되었습니다",
      failed: "업데이트에 실패했습니다. 잠시 후 다시 시도해 주세요",
    },
    delete: {
      confirm: "이 기억을 삭제하시겠습니까?",
      confirmButton: "삭제",
      success: "기억이 삭제되었습니다",
      failed: "삭제에 실패했습니다. 잠시 후 다시 시도해 주세요",
    },
    clear: {
      button: "기억 비우기",
      title: "모든 기억 비우기",
      description: "{count}개의 모든 기억이 삭제되며 되돌릴 수 없습니다.",
      tip: "이 작업은 모든 대화의 기억 회상에 영향을 줍니다. 신중하게 진행해 주세요.",
      inputPlaceholder: "확인하려면 \"{word}\"를 입력하세요",
      confirmWord: "기억 비우기",
      confirm: "비우기",
      cancel: "취소",
      success: "{count}개의 기억을 비웠습니다",
      failed: "비우기에 실패했습니다. 잠시 후 다시 시도해 주세요",
    },
  },
  chatHeader: {
  ...
  newUserGuide: {
    ...
    steps: {
      welcome: {
        title: "Zilan에 오신 것을 환영합니다",
        desc: "몇 단계만으로 지식 베이스, 대화, 에이전트의 핵심 사용법을 안내합니다. '다음'을 눌러 시작하세요.",
      },
      knowledge: {
        title: "지식 베이스 만들기",
        desc: "모든 것의 시작점입니다. 문서, 웹페이지, FAQ를 업로드하면 Zilan가 자동으로 분석하고 색인합니다. 여기를 클릭해 지식 베이스로 이동하세요.",
      },
      chat: {
        title: "AI 대화 시작하기",
  ...
  settings: {
    ...
    storage: {
      ...
      pathPrefixPlaceholder: '예: zilan/images',
      prefixPlaceholder: '예: zilan',
  ...
  auth: {
    ...
    registerSubtitle: "계정을 만들고 Zilan를 시작하세요",
    ...
    // ---- P0-4 듀얼 채널 가입/로그인 및 인증 코드 ----
    account: "휴대폰 / 이메일",
    accountPlaceholder: "휴대폰 번호 또는 이메일 입력",
    identifierRequired: "휴대폰 번호 또는 이메일을 입력해주세요",
    identifierInvalid: "형식이 올바르지 않습니다. 유효한 휴대폰 번호 또는 이메일을 입력해주세요",
    phone: "휴대폰 번호",
    phonePlaceholder: "11자리 휴대폰 번호 입력",
    phoneRequired: "휴대폰 번호를 입력해주세요",
    phoneInvalid: "올바른 11자리 중국 대륙 휴대폰 번호를 입력해주세요",
    phoneTab: "휴대폰으로 가입",
    emailTab: "이메일로 가입",
    phoneTaken: "이미 등록된 휴대폰 번호입니다",
    emailTaken: "이미 등록된 이메일 주소입니다",
    usernameTaken: "이미 사용 중인 사용자 이름입니다",
    registerPasswordPlaceholder: "비밀번호 설정 (8-32자, 대소문자 및 숫자 포함)",
    passwordPolicyHint: "비밀번호는 8-32자이며 대문자, 소문자, 숫자를 모두 포함해야 합니다",
    passwordMustContainUppercase: "비밀번호에 대문자를 포함해야 합니다",
    passwordMustContainLowercase: "비밀번호에 소문자를 포함해야 합니다",
    ...
    captcha: {
      title: "사람 확인",
      sliderHint: "슬라이더를 드래그하여 퍼즐을 완성하세요",
      textPlaceholder: "그림 속 숫자 입력",
      loading: "보안문자 불러오는 중...",
      loadFailed: "보안문자를 불러오지 못했습니다",
      retry: "다시 시도",
      refresh: "새로고침",
      passed: "확인 완료",
      passedHint: "사람 확인이 완료되었습니다",
      failedHint: "확인에 실패했습니다. 다시 시도해주세요",
      required: "먼저 사람 확인을 완료해주세요",
    },
    verification: {
      send: "인증번호 받기",
      resendIn: "{seconds}초 후 재전송",
      smsSent: "인증번호가 발송되었습니다. 문자를 확인해주세요",
      emailSent: "인증번호가 발송되었습니다. 이메일을 확인해주세요",
      smsCode: "문자 인증번호",
      emailCode: "이메일 인증번호",
      codePlaceholder: "6자리 인증번호 입력",
      codeRequired: "인증번호를 입력해주세요",
      codeInvalid: "6자리 숫자 인증번호를 입력해주세요",
      codeExpired: "인증번호가 만료되었습니다. 새로 요청해주세요",
      codeMismatch: "인증번호가 올바르지 않습니다. 확인 후 다시 시도해주세요",
      tooManyAttempts: "오류 횟수가 많습니다. 새 인증번호를 요청해주세요",
      invalidTarget: "휴대폰 번호 또는 이메일 형식이 올바르지 않습니다",
      channelDisabled: "인증번호 발송 채널이 설정되지 않았습니다. 관리자에게 문의해주세요",
      resendTooFrequent: "전송이 너무 잦습니다. 잠시 후 다시 시도해주세요",
      dailyLimit: "일일 발송 한도에 도달했습니다. 내일 다시 시도해주세요",
      sendFailed: "인증번호 전송에 실패했습니다. 나중에 다시 시도해주세요",
    },
    workspaceOnboarding: {
      title: "작업 공간 선택",
  ...
  system: {
    ...
    retry: "재시도",
    versionLabel: "앱 버전",
    versionDescription: "애플리케이션 서비스(zilan-app)의 버전 번호",
    frontendVersionLabel: "UI 버전",
    frontendVersionDescription: "UI(zilan-ui) 빌드 버전 번호",
    ...
    globalSettings: {
      ...
      backup: {
        tabLabel: "백업 및 복구",
        description:
          "사용자 데이터의 매일 자동 스냅샷: 워크스페이스별 메타데이터 논리 내보내기, 파일 계층 객체 복사, 복구 전 SHA-256 무결성 검사. 시스템 관리자만 볼 수 있습니다.",
        loading: "불러오는 중...",
        retry: "재시도",
        loadFailed: "백업 기록을 불러오지 못했습니다",
        disabledTitle: "백업 하위 시스템이 비활성화되었습니다",
        disabledMessage:
          "이 배포에서는 백업이 비활성화되어 있습니다(WEKNORA_BACKUP_ENABLED=false). 활성화하면 이 페이지에 백업 상태, 기록, 복구 진입점이 표시됩니다.",
        never: "백업 없음",
        lastSuccess: "마지막 성공 백업",
        rpoCountdown: "다음 예정 백업",
        rpoIn: "약 {hours}시간 후(매일 03:00)",
        rpoOverdue: "예상 창 초과",
        retentionPolicy: "보존 정책",
        retentionPolicyValue: "일간 {d} / 주간 {w} / 월간 {m}",
        runNow: "지금 백업",
        runSuccess: "백업 완료",
        runFailed: "백업 실패",
        deleteConfirm: "이 스냅샷과 저장된 모든 객체를 삭제합니까? 되돌릴 수 없습니다.",
        deleteSuccess: "스냅샷 삭제됨",
        deleteFailed: "삭제 실패",
        status: {
          running: "진행 중",
          succeeded: "성공",
        ...
        records: {
          title: "백업 기록",
          empty: "백업 기록이 없습니다. 위의「지금 백업」으로 첫 스냅샷을 만들 수 있습니다.",
          filterAll: "전체 상태",
          snapshot: "스냅샷",
          statusCol: "상태",
          triggerCol: "출처",
        ...
        export: {
          title: "워크스페이스별 내보내기",
          hint:
            "단일 워크스페이스의 메타데이터와 모든 파일을 tar.gz 아카이브로 패키징하여 다운로드합니다. 다른 인스턴스로의 이전이나 컴플라이언스 보존에 사용합니다.",
          tenantId: "워크스페이스 ID",
          download: "아카이브 내보내기",
          success: "내보내기 다운로드 시작",
          failed: "내보내기 실패",
        },
        restore: {
          action: "복구",
          title: "복구 마법사",
          description:
            "스냅샷에서 데이터를 복구합니다. 쓰기 전에 모든 항목의 SHA-256 무결성을 검사하며, 손상이 있으면 복구가 중단되고 손상 항목이 표시됩니다.",
          stepScope: "1단계: 범위",
          scopeTenant: "워크스페이스별 복구(권장 — 선택한 워크스페이스에만 적용)",
          scopeInstance: "전체 인스턴스 복구(재해 복구 — 모든 워크스페이스에 적용)",
          stepTenant: "2단계: 워크스페이스 및 충돌 정책",
          modeNew: "새 워크스페이스로 복구(원래 이름에 -restored- 접미사, 가장 안전)",
          modeOverwrite: "대상 워크스페이스 덮어쓰기(먼저 정리 후 가져오기)",
          modeNote:
            "「새 워크스페이스로 복구」는 기존 데이터를 건드리지 않습니다. 「덮어쓰기」는 대상 워크스페이스의 기존 데이터를 먼저 삭제합니다.",
          dryRun: "시험 실행",
          dryRunTitle: "시험 실행 보고서",
          wouldRows: "복구될 행 수",
          wouldFiles: "복구될 파일 수",
          execute: "복구 실행",
          executeConfirm: "복구를 실행합니까? 데이터베이스와 파일 저장소에 기록됩니다.",
          overwriteConfirm: "덮어쓰기 모드는 대상 워크스페이스의 기존 데이터를 먼저 지웁니다. 계속합니까?",
          progressTitle: "복구 진행 상황",
          rowsRestored: "복구된 행 {n}",
          filesRestored: "기록된 파일 {n}",
          rowsSkipped: "건너뛴 충돌 행 {n}",
          reindexQueued: "대기 중인 인덱스 재구축 {n}",
          newTenant: "새 워크스페이스 ID: {id}",
          success: "복구 완료",
          failed: "복구 실패",
        },
        jobStatus: {
  ...
  createChat: {
    title: "안녕하세요, Zilan입니다 — 당신의 지식을 손끝에",
  ...
  integrations: {
    ...
    api: {
      ...
      capabilityManageKbsHint: "지식베이스 전체 수명 주기를 관리할 수 있습니다: 생성, 복사, 수정, 삭제 및 초기화/설정 변경. 기존 지식베이스에 대한 작업(복사/수정/삭제)은 선택한 범위로 제한되며, 새 지식베이스 생성은 제한되지 않습니다(새 지식베이스는 이 스페이스에 속함).",
	      ...
	      capabilityManageModelsHint: "모델 설정, 자격 증명, 연결 테스트 및 Zilan Cloud 자격 증명을 관리합니다.",
      ...
      signedFlowDetail:
        "HMAC secret은 Zilan와 신뢰할 수 있는 백엔드에만 보관하세요. 요청에 넣거나 브라우저에 배포하지 마세요. 요청 헤더에는 secret이 아니라 해당 secret으로 서명한 JWT 문자열을 넣습니다(발급마다 또는 만료 후 변경). JWT에는 sub(외부 사용자 ID), tenant_id, aud=zilan, exp(최대 24시간)가 필요합니다.",
      ...
      hmacSecretDesc: "Zilan에 저장된 것과 동일한 secret. 백엔드에서 JWT 서명에만 사용하며 요청 헤더로 보내지 않습니다.",
      ...
      signedRequestStep0:
        "# 0. 백엔드에서 JWT 서명 (HS256, aud=zilan, sub=사용자 ID, tenant_id={tenantId}, exp 최대 24시간)",
    ...
    chrome: {
      title: "지식 관리 어시스턴트",
      subtitle:
        "자체 호스팅 Zilan와 함께: 사이드바에서 질문하고, 웹 페이지를 클리핑하며, Markdown 메모를 지식베이스에 저장하세요.",
      ...
      steps: {
        ...
        port: {
          title: "데스크톱: 고정 포트(권장)",
          desc: "Zilan 데스크톱에서는 API 정보에서 고정 포트(예: 37841)를 설정하세요.",
        },
        install: {
          title: "Chrome 확장 설치",
    ...
    claw: {
      title: "Zilan Skill",
      subtitle:
        "Zilan REST API로 문서를 가져오고 하이브리드 검색(벡터+키워드)을 수행합니다. 파일/URL/Markdown 업로드 및 검색에 사용.",
      ...
      steps: {
        ...
        env: {
          title: "환경 변수 설정",
          desc: "셸 또는 ~/.zshrc, ~/.bashrc에 ZILAN_BASE_URL과 ZILAN_API_KEY를 설정하세요. 아래 예시는 현재 API 주소를 사용하며, API Key는 실제 값으로 바꾸세요.",
        },
        install: {
          title: "Skill 설치",
      ...
      installCtaHint: "Zilan Skill 설치 · 새 탭에서 열림",
