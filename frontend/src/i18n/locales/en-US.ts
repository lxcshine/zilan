export default {
  // ===== Three-column layout / mode navigation (PRD ui-layout-visual-redesign) =====
  rail: {
    ariaLabel: 'Primary navigation',
    backHome: 'Back to new chat',
    chat: 'Chat',
  ...
  panel: {
    ...
    searchSessions: 'Search session titles',
    ...
    kbDisabled: 'Disabled',
    builtinTag: 'Built-in',
    filterByStatus: 'Filter by parse status',
    chooseKnowledgeBase: 'Choose a target knowledge base',
    statusAll: 'All',
    statusProcessing: 'Parsing',
    statusCompleted: 'Completed',
    statusFailed: 'Failed',
    memorySoul: 'Soul',
    memoryProfile: 'User Profile',
    memoryStream: 'Memory Stream',
    memoryTips: 'Tips & Skills',
  },
  hero: {
  ...
  quickActions: {
    title: 'Quick actions',
    docAnalyze: 'Doc Insights',
    smartWriting: 'Smart Writing',
    webSummary: 'Web Summary',
    newKnowledgeBase: 'New Knowledge Base',
    webSummaryPrompt: 'Summarize this web page: ',
    writingContinue: 'Continue',
    writingContinuePrompt: 'Continue writing the following content: ',
    writingPolish: 'Polish',
    writingPolishPrompt: 'Polish the following text to make it more fluent and professional: ',
    writingSummarize: 'Summarize',
    writingSummarizePrompt: 'Summarize the following content in bullet points: ',
    writingTranslate: 'Translate',
    writingTranslatePrompt: 'Translate the following content into English: ',
  },
  documents: {
    subtitle: 'A cross-knowledge-base overview of your document assets, tracking parse progress and status',
    totalDocuments: 'Total documents',
    recentDocuments: 'Recently updated',
    backToList: 'Back to documents',
    reparse: 'Re-parse',
    reparseStarted: 'Re-parse started',
    reparseFailed: 'Failed to start re-parse, please try again later',
    deleteConfirmTitle: 'Delete document',
    deleteConfirmBody: 'The document and its index cannot be recovered after deletion. Delete it?',
  ...
  memory: {
    title: 'My Memory',
    subtitle: '{count} memories captured and automatically recalled in conversations',
    switchLabel: 'Memory',
    switchEnabled: 'Memory enabled',
    switchDisabled: 'Memory disabled',
    ...
    modules: {
      ...
      agent: 'Agent Tips',
      soulDesc: 'Assistant persona and your directives',
      userDesc: 'How the AI sees you',
      memoryDesc: 'All long-term memories',
      agentDesc: 'Know-how distilled by the assistant',
      countLabel: '{module}: {count} items',
      summaryTitle: 'Includes {n} session summaries',
    },
    soul: {
      personaBadge: 'Global Persona',
      expand: 'Expand',
      collapse: 'Collapse',
      adjustmentsTitle: 'My Style Directives',
      adjustmentsHint: 'Just tell the assistant in a chat, e.g. "Call me Mr. Zhang" or "Answer in bullet points".',
      emptyTitle: 'No style directives yet',
      emptyDescription: 'Tell the assistant how to address you and your style preferences, e.g. "Call me Mr. Zhang and keep answers brief". Directives are captured automatically and shape every reply.',
      cta: 'Tell the Assistant',
    },
    profile: {
      ...
      viewInMemory: 'View in memory stream',
      emptyTitle: 'Your profile is empty',
      emptyDescription: 'Chat about your job, responsibilities and preferences — the AI will capture them into your profile automatically.',
      cta: 'Start a Chat',
    },
    agent: {
      skillsTitle: 'Assistant Skills',
      skillsHint: 'Know-how distilled from your feedback, injected into every reply',
      skillsEmptyDescription: 'Tell the assistant explicitly how to improve (e.g. "Conclusion first"). Accepted feedback becomes a reusable skill.',
      fromFeedback: 'From your feedback: {content}',
      feedbackTitle: 'Feedback Wall',
      feedbackHint: 'All your feedback, fully traceable',
      upgraded: 'Upgraded to skill',
      pending: 'Pending distillation',
      distillCta: 'Distill into a skill',
      feedbackEmpty: 'No feedback yet',
      emptyTitle: 'No know-how yet',
      emptyDescription: 'When the assistant receives your explicit feedback, it distills the improvement into reusable skills.',
    },
    status: {
      active: 'Active',
      done: 'Done',
    ...
    card: {
      ...
      due: 'Due {date}',
      lastRecall: 'Last recall',
      recalled: 'Recalled {n} times',
    ...
    empty: {
      ...
      description: 'Important details from your conversations will be captured here and automatically recalled later.',
      filteredTitle: 'No matching memories',
      filteredDescription: 'Try a different keyword or filter.',
      cta: 'Start a conversation',
    },
    error: {
      title: 'Failed to load',
      description: 'Failed to load the memory list, please try again later.',
      retry: 'Retry',
    },
    notAvailable: {
      title: 'Memory service unavailable',
      description: 'The memory service is not enabled in this environment. Please contact your administrator.',
    },
    edit: {
      title: 'Edit Memory',
      category: 'Category',
      categoryHint: 'Categories are determined at extraction and cannot be changed',
      content: 'Content',
      contentPlaceholder: 'Describe this memory',
      contentRequired: 'Content is required',
      object: 'Related object',
      objectPlaceholder: 'Optional, e.g. product or project name',
      importance: 'Importance',
      status: 'Status',
      due: 'Due date',
      duePlaceholder: 'Select a date',
      reembedHint: 'After saving, the system will regenerate the embedding so the edit takes effect on the next recall.',
      save: 'Save',
      success: 'Memory updated',
      failed: 'Failed to update, please try again later',
    },
    delete: {
      confirm: 'Delete this memory?',
      confirmButton: 'Delete',
      success: 'Memory deleted',
      failed: 'Failed to delete, please try again later',
    },
    clear: {
      button: 'Clear Memory',
      title: 'Clear all memories',
      description: 'You are about to delete all {count} memories. This cannot be undone.',
      tip: 'This affects memory recall across all conversations. Proceed with caution.',
      inputPlaceholder: 'Type "{word}" to confirm',
      confirmWord: 'CLEAR MEMORY',
      confirm: 'Clear',
      cancel: 'Cancel',
      success: 'Cleared {count} memories',
      failed: 'Failed to clear, please try again later',
    },
  },
  chatHeader: {
  ...
  newUserGuide: {
    ...
    steps: {
      ...
      knowledge: {
        ...
        desc: 'Everything starts here: upload documents, web pages or FAQs and Zilan parses and indexes them automatically. Click here to open knowledge bases.',
      },
      chat: {
  ...
  settings: {
    ...
    weknoraCloud: {
      title: 'Zilan Cloud',
      description: 'Configure Zilan Cloud APPID and APPSECRET credentials. Credentials are used for model services and document parsing engine.',
      viewDocs: 'View Docs',
      unconfigured: 'Credentials not configured. Please fill in APPID and APPSECRET.',
      configured: 'Credentials configured and working.',
      expired: 'Zilan Cloud credentials expired',
      ...
      appIdLabel: 'APPID',
      appIdDesc: 'Zilan Cloud application ID',
      appIdPlaceholder: 'Enter APPID',
      appSecretLabel: 'APPSECRET',
      appSecretDesc: 'Zilan Cloud application secret',
      ...
      credentialConfigured: 'Zilan Cloud credentials configured.',
      credentialExpired: 'Credentials expired. Please reconfigure.',
      credentialUnconfigured: 'Zilan Cloud credentials not configured. Please set up APPID and APPSECRET first.',
      checkingStatus: 'Checking credential status...',
      goToSettings: 'Go to Settings',
      modelHintConfigured: 'Zilan Cloud credentials configured. See supported models in',
      modelHintDocsLink: 'API docs',
      modelsSection: {
        title: 'Cloud Models',
        descReady: 'Register the four standard Zilan Cloud models for chat, retrieval, reranking, and vision.',
    ...
    storage: {
      ...
      pathPrefixPlaceholder: 'e.g. zilan/images',
      prefixPlaceholder: 'e.g. zilan',
  ...
  auth: {
    ...
    // ---- P0-4 dual-channel registration/login + verification codes ----
    account: 'Phone / Email',
    accountPlaceholder: 'Enter phone number or email',
    identifierRequired: 'Please enter a phone number or email',
    identifierInvalid: 'Invalid format, please enter a valid phone number or email',
    phone: 'Phone number',
    phonePlaceholder: 'Enter an 11-digit phone number',
    phoneRequired: 'Please enter a phone number',
    phoneInvalid: 'Please enter a valid 11-digit mainland China mobile number',
    phoneTab: 'Register with phone',
    emailTab: 'Register with email',
    phoneTaken: 'This phone number is already registered',
    emailTaken: 'This email address is already registered',
    usernameTaken: 'This username is already taken',
    registerPasswordPlaceholder: 'Set password (8-32 chars, upper & lower case letters and numbers)',
    passwordPolicyHint: 'Password must be 8-32 characters and contain uppercase letters, lowercase letters and numbers',
    ...
    captcha: {
      ...
      sliderHint: 'Drag the slider to complete the puzzle',
      textPlaceholder: 'Enter the digits',
      loading: 'Loading captcha...',
      loadFailed: 'Failed to load captcha',
      retry: 'Retry',
      refresh: 'Refresh',
      passed: 'Verified',
      passedHint: 'Human verification passed',
      failedHint: 'Verification failed, please try again',
      required: 'Please complete human verification first',
    },
    verification: {
      send: 'Send code',
      resendIn: 'Resend in {seconds}s',
      smsSent: 'Code sent, please check your SMS',
      emailSent: 'Code sent, please check your inbox',
      smsCode: 'SMS code',
      ...
      codeMismatch: 'Incorrect code, please check and try again',
      tooManyAttempts: 'Too many failed attempts, please request a new code',
      invalidTarget: 'Invalid phone number or email format',
      channelDisabled: 'Verification channel is not configured, please contact the administrator',
      resendTooFrequent: 'Sending too frequently, please try again later',
      dailyLimit: 'Daily send limit reached, please try again tomorrow',
  ...
  createChat: {
    title: 'Hi, I am Zilan — your knowledge, within reach',
  ...
  embedPublish: {
    ...
    webhookUrlPlaceholder: 'https://your-server.example.com/zilan/embed-events',
    webhookUrlDesc: 'Optional. Zilan POSTs message_sent / message_received events to this HTTPS endpoint.',
    webhookSecret: 'Webhook secret',
    webhookSecretPlaceholder: 'HMAC-SHA256 secret (X-Zilan-Signature header)',
...
\
  ...
  system: {
    ...
    versionDescription: 'Version of the application service (zilan-app)',
    frontendVersionLabel: 'UI Version',
    frontendVersionDescription: 'Build version of the UI (zilan-ui)',
    ...
    globalSettings: {
      ...
      backup: {
        tabLabel: 'Backup & Recovery',
        description:
          'Daily automatic snapshots of user data: per-workspace metadata logical export, file-tier object copy, and SHA-256 integrity verification before every restore. Visible to system admins only.',
        loading: 'Loading...',
        retry: 'Retry',
        loadFailed: 'Failed to load backup records',
        disabledTitle: 'Backup subsystem is disabled',
        disabledMessage:
          'This deployment has backup disabled (WEKNORA_BACKUP_ENABLED=false). Once enabled, this page shows backup status, records, and the restore entry point.',
        never: 'Never',
        lastSuccess: 'Last successful backup',
        rpoCountdown: 'Next scheduled backup',
        rpoIn: 'In about {hours} hours (daily at 03:00)',
        rpoOverdue: 'Past the expected window',
        retentionPolicy: 'Retention policy',
        retentionPolicyValue: '{d} daily / {w} weekly / {m} monthly',
        runNow: 'Back up now',
        runSuccess: 'Backup completed',
        runFailed: 'Backup failed',
        deleteConfirm: 'Delete this snapshot and all of its stored objects? This cannot be undone.',
        ...
        trigger: {
          scheduled: 'Scheduled',
          manual: 'Manual',
          'pre-delete': 'Pre-delete snapshot',
        },
        retention: {
          daily: 'Daily',
          weekly: 'Weekly',
        ...
        records: {
          ...
          empty: 'No backup records yet. Use "Back up now" above to create the first snapshot.',
          filterAll: 'All statuses',
          snapshot: 'Snapshot',
          statusCol: 'Status',
          triggerCol: 'Source',
          startedCol: 'Started at',
          statsCol: 'Statistics',
          errorCol: 'Failure reason',
          actionsCol: 'Actions',
        },
        export: {
          title: 'Per-workspace export',
          hint:
            'Packages one workspace\u2019s metadata and all of its files into a tar.gz archive download — for migrating to another instance or compliance retention.',
          tenantId: 'Workspace ID',
        ...
        restore: {
          ...
          description:
            'Restores data from a snapshot. SHA-256 integrity is verified item by item before anything is written; any damage aborts the restore and names the damaged entry.',
          stepScope: 'Step 1: Scope',
          scopeTenant: 'Per workspace (recommended — affects only the selected workspace)',
          scopeInstance: 'Full instance (disaster recovery — affects every workspace)',
          stepTenant: 'Step 2: Workspace and conflict policy',
          modeNew: 'Restore as a new workspace (original name with -restored- suffix, safest)',
          modeOverwrite: 'Overwrite the target workspace (clear first, then import)',
          modeNote:
            '"Restore as new" never touches existing workspace data; "Overwrite" deletes the target workspace\u2019s current data first.',
          dryRun: 'Dry run',
          dryRunTitle: 'Dry-run report',
          wouldRows: 'Rows to restore',
          wouldFiles: 'Files to restore',
          execute: 'Execute restore',
          executeConfirm: 'Run the restore? This writes to the database and file storage.',
          overwriteConfirm: 'Overwrite mode clears the target workspace\u2019s existing data first. Proceed?',
          progressTitle: 'Restore progress',
          rowsRestored: '{n} rows restored',
          filesRestored: '{n} files written back',
          rowsSkipped: '{n} conflicting rows skipped',
          reindexQueued: '{n} index rebuilds queued',
          newTenant: 'New workspace ID: {id}',
  ...
  kbSettings: {
    ...
    parser: {
      ...
      engines: {
        ...
        weknoracloud: {
          name: 'Zilan Cloud',
          desc: 'Document parsing via Zilan Cloud',
        },
        markitdown: {
          name: 'MarkItDown',
  ...
  integrations: {
    ...
    api: {
      ...
      capabilityManageKbsHint: 'Let this key manage the full knowledge-base lifecycle: create, copy, update, and delete knowledge bases and change their initialization/configuration. Operations on existing knowledge bases (copy/update/delete) stay bounded by the selected scope; creating a new knowledge base is unrestricted (the new KB belongs to this space).',
	      ...
	      capabilityManageModelsHint: 'Manage model definitions, credentials, connectivity checks, and Zilan Cloud credentials.',
      ...
      hmacSecretDesc: 'Same secret stored in Zilan; used only on your backend to sign JWTs—never send it as a request header.',
      ...
      signedRequestStep0:
        '# 0. Sign JWT on your backend (HS256, aud=zilan, sub=user id, tenant_id={tenantId}, exp<=24h)',
    ...
    chrome: {
      ...
      subtitle:
        'For self-hosted Zilan: ask questions in a sidebar, clip web pages, and save Markdown notes into your knowledge bases while you browse.',
      ...
      steps: {
        ...
        port: {
          ...
          desc: 'On Zilan Desktop, set a fixed API port (e.g. 37841) in API Info so the URL stays stable across restarts.',
        },
        install: {
    ...
    claw: {
      title: 'Zilan Skill',
      subtitle:
        'Import documents and run hybrid retrieval (vector + keyword) via the Zilan REST API—for uploads, URL imports, Markdown entries, and cross-KB search.',
      ...
      steps: {
        ...
        env: {
          ...
          desc: 'Set ZILAN_BASE_URL and ZILAN_API_KEY in your shell or ~/.zshrc / ~/.bashrc. The example below uses your current API base URL—replace the API Key with your actual value.',
        },
        install: {
      ...
      installCtaHint: 'Install Zilan Skill · opens in a new tab',
