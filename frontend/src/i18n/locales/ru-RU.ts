export default {
  // ===== Трёхколоночная раскладка / режимная навигация (PRD ui-layout-visual-redesign) =====
  rail: {
    ariaLabel: 'Основная навигация',
    backHome: 'К новому диалогу',
    chat: 'Диалоги',
  ...
  panel: {
    historySessions: 'История',
    searchSessions: 'Поиск по заголовкам',
    searchKnowledgeBases: 'Поиск баз знаний',
    searchAgents: 'Поиск агентов',
    newKnowledgeBase: 'Новая база знаний',
    ...
    untitledDocument: 'Без названия',
    kbEnabled: 'Включена',
    kbDisabled: 'Отключена',
    builtinTag: 'Встроенный',
    filterByStatus: 'Фильтр по статусу разбора',
    chooseKnowledgeBase: 'Выберите целевую базу знаний',
    statusAll: 'Все',
    statusProcessing: 'Разбор',
    statusCompleted: 'Завершено',
    statusFailed: 'Ошибка',
    memorySoul: 'Душа',
    memoryProfile: 'Профиль пользователя',
    memoryStream: 'Поток памяти',
    memoryTips: 'Советы и навыки',
  },
  hero: {
    copilotBadge: 'Zilan Copilot',
  },
  quickActions: {
    title: 'Быстрые действия',
    docAnalyze: 'Разбор документа',
    smartWriting: 'Умное письмо',
    webSummary: 'Сводка веб-страницы',
    newKnowledgeBase: 'Новая база знаний',
    webSummaryPrompt: 'Сделай сводку этой веб-страницы: ',
    writingContinue: 'Продолжить',
    writingContinuePrompt: 'Продолжи написание следующего текста: ',
    writingPolish: 'Отшлифовать',
    writingPolishPrompt: 'Отшлифуй следующий текст, сделав его более плавным и профессиональным: ',
    writingSummarize: 'Сводка',
    writingSummarizePrompt: 'Сделай сводку следующего текста в виде тезисов: ',
    writingTranslate: 'Перевод',
    writingTranslatePrompt: 'Переведи следующий текст на английский: ',
  },
  documents: {
    subtitle: 'Сводка документов по всем базам знаний: прогресс и статус разбора',
    totalDocuments: 'Всего документов',
    recentDocuments: 'Недавно обновлённые',
    backToList: 'Назад к документам',
    reparse: 'Переразобрать',
    reparseStarted: 'Переразбор запущен',
    reparseFailed: 'Не удалось запустить переразбор, попробуйте позже',
    deleteConfirmTitle: 'Удалить документ',
    deleteConfirmBody: 'Документ и его индекс нельзя восстановить после удаления. Удалить?',
  ...
  memory: {
    title: 'Моя память',
    subtitle: 'Сохранено воспоминаний: {count}. Они автоматически вспоминаются в диалогах',
    switchLabel: 'Память',
    switchEnabled: 'Память включена',
    switchDisabled: 'Память выключена',
    switchFailed: 'Не удалось изменить настройку, попробуйте позже',
    disabledBanner: 'Память выключена: сохранённые воспоминания не потеряются, но ассистент перестанет извлекать и вспоминать их.',
    searchPlaceholder: 'Поиск по воспоминаниям',
    resident: {
      badge: 'Всегда',
      tooltip: 'Постоянная инъекция: добавляется в каждый диалог независимо от релевантности вопроса',
    },
    categories: {
      all: 'Все',
      profile: 'Профиль',
    ...
    modules: {
      ...
      memory: 'Память',
      agent: 'Опыт',
      soulDesc: 'Характер помощника и ваши указания',
      userDesc: 'Как вас видит ИИ',
      memoryDesc: 'Все долгосрочные воспоминания',
      agentDesc: 'Методы, усвоенные помощником',
      countLabel: '{module}: {count}',
      summaryTitle: 'Включая {n} сводок сессий',
    },
    soul: {
      personaBadge: 'Глобальный образ',
      expand: 'Развернуть',
      collapse: 'Свернуть',
      adjustmentsTitle: 'Мои стилевые указания',
      adjustmentsHint: 'Просто скажите помощнику в чате, например: «Называйте меня Чжан» или «Отвечайте тезисно».',
      emptyTitle: 'Пока нет стилевых указаний',
      emptyDescription: 'Скажите помощнику, как к вам обращаться и какой стиль предпочитаете, — указания сохранятся автоматически и будут влиять на каждый ответ.',
      cta: 'Сказать помощнику',
    },
    profile: {
      completeness: 'Полнота профиля',
      completenessHint: 'Дополняется автоматически при общении',
      residentHint: 'Профиль, предпочтения и директивы стиля вводятся в каждый диалог — не нужно представляться заново',
      sections: {
        identity: 'Личность',
        role: 'Должность',
        preference: 'Предпочтения',
      ...
      emptySection: 'Пока ничего',
      viewInMemory: 'Открыть в потоке памяти',
      emptyTitle: 'Профиль пуст',
      emptyDescription: 'Расскажите помощнику о своей работе и предпочтениях — ИИ наполнит профиль автоматически.',
      cta: 'Начать беседу',
    },
    agent: {
      skillsTitle: 'Навыки помощника',
      skillsHint: 'Методы из ваших отзывов, добавляются в каждый ответ',
      skillsEmptyDescription: 'Ясно скажите помощнику, что улучшить (например, «сначала вывод»), — принятая обратная связь станет навыком.',
      fromFeedback: 'Из вашего отзыва: {content}',
      feedbackTitle: 'Стена отзывов',
      feedbackHint: 'Все ваши отзывы, с историей',
      upgraded: 'Преобразовано в навык',
      pending: 'Ожидает обработки',
      distillCta: 'Превратить в навык',
      feedbackEmpty: 'Отзывов пока нет',
      emptyTitle: 'Опыта пока нет',
      emptyDescription: 'Когда помощник получает явный отзыв, он превращает улучшение в повторно используемый навык.',
    },
    status: {
      active: 'Активные',
      done: 'Завершённые',
    ...
    card: {
      ...
      due: 'Срок {date}',
      lastRecall: 'Последнее вспоминание',
      recalled: 'Вспоминалось {n} раз',
      neverRecalled: 'Ни разу не вспоминалось',
    },
    time: {
      justNow: 'только что',
    ...
    empty: {
      ...
      description: 'Важные сведения из ваших диалогов будут автоматически сохраняться здесь и вспоминаться в дальнейшем.',
      filteredTitle: 'Ничего не найдено',
      filteredDescription: 'Попробуйте другой запрос или фильтр.',
      cta: 'Начать диалог',
    },
    error: {
      title: 'Не удалось загрузить',
      description: 'Не удалось загрузить список воспоминаний, попробуйте позже.',
      retry: 'Повторить',
    },
    notAvailable: {
      title: 'Сервис памяти недоступен',
      description: 'Сервис памяти не включён в этом окружении. Обратитесь к администратору.',
    },
    edit: {
      title: 'Редактирование воспоминания',
      category: 'Категория',
      categoryHint: 'Категория определяется при извлечении и не может быть изменена',
      content: 'Содержание',
      contentPlaceholder: 'Опишите это воспоминание',
      contentRequired: 'Содержание обязательно',
      object: 'Связанный объект',
      objectPlaceholder: 'Необязательно, например название продукта или проекта',
      importance: 'Важность',
      status: 'Статус',
      due: 'Срок',
      duePlaceholder: 'Выберите дату',
      reembedHint: 'После сохранения система пересоздаст векторное представление, и изменение вступит в силу при следующем вспоминании.',
      save: 'Сохранить',
      success: 'Воспоминание обновлено',
      failed: 'Не удалось обновить, попробуйте позже',
    },
    delete: {
      confirm: 'Удалить это воспоминание?',
      confirmButton: 'Удалить',
      success: 'Воспоминание удалено',
      failed: 'Не удалось удалить, попробуйте позже',
    },
    clear: {
      button: 'Очистить память',
      title: 'Очистить всю память',
      description: 'Будут удалены все воспоминания ({count}). Это действие необратимо.',
      tip: 'Это повлияет на вспоминание в всех диалогах. Действуйте осторожно.',
      inputPlaceholder: 'Введите «{word}» для подтверждения',
      confirmWord: 'ОЧИСТИТЬ ПАМЯТЬ',
      confirm: 'Очистить',
      cancel: 'Отмена',
      success: 'Удалено воспоминаний: {count}',
      failed: 'Не удалось очистить, попробуйте позже',
    },
  },
  chatHeader: {
  ...
  newUserGuide: {
    ...
    steps: {
      welcome: {
        title: 'Добро пожаловать в Zilan',
      ...
      knowledge: {
        ...
        desc: 'С этого всё начинается: загружайте документы, веб-страницы или FAQ, и Zilan автоматически разберёт и проиндексирует их. Нажмите здесь, чтобы открыть базы знаний.',
      },
      chat: {
  ...
  settings: {
    ...
    weknoraCloud: {
      title: 'Zilan Cloud',
      description: 'Настройте учётные данные APPID и APPSECRET для Zilan Cloud. Данные используются для модельных сервисов и движка парсинга документов.',
      ...
      expired: 'Учётные данные Zilan Cloud истекли',
      ...
      appIdLabel: 'APPID',
      appIdDesc: 'ID приложения Zilan Cloud',
      appIdPlaceholder: 'Введите APPID',
      appSecretLabel: 'APPSECRET',
      appSecretDesc: 'Секрет приложения Zilan Cloud',
      ...
      usageSteps: '1. Сохраните APPID и APPSECRET\n2. Добавьте chat, embedding, rerank и vlm в разделе «Облачные модели» ниже\n3. Парсинг: Настройки БЗ → Движок парсинга → Zilan Cloud',
      fillRequired: 'Заполните APPID и APPSECRET',
      saveSuccess: 'Учётные данные сохранены',
      saveFailed: 'Не удалось сохранить данные',
      credentialConfigured: 'Учётные данные Zilan Cloud настроены.',
      credentialExpired: 'Данные истекли. Перенастройте.',
      credentialUnconfigured: 'Учётные данные Zilan Cloud не настроены. Заполните APPID и APPSECRET.',
      checkingStatus: 'Проверка статуса...',
      goToSettings: 'Перейти в настройки',
      modelHintConfigured: 'Учётные данные Zilan Cloud настроены. Поддерживаемые модели см. в',
      modelHintDocsLink: 'документации API',
      modelsSection: {
        title: 'Облачные модели',
        descReady: 'Зарегистрируйте четыре стандартные модели Zilan Cloud для чата, поиска, реранкинга и зрения.',
      ...
      addModelsDisplayName: {
        chat: 'Zilan Cloud Chat',
        embedding: 'Zilan Cloud Embedding',
        rerank: 'Zilan Cloud ReRank',
        vllm: 'Zilan Cloud Vision',
      },
    },
    ...
    storage: {
      ...
      pathPrefixPlaceholder: 'напр. zilan/images',
      prefixPlaceholder: 'напр. zilan',
...
/example\.(net|org)/`,
  ...
  initialization: {
    title: 'Инициализация',
    welcome: 'Добро пожаловать в Zilan',
  ...
  auth: {
    ...
    registerSubtitle: 'Создайте аккаунт и начните работу с Zilan',
    ...
    // ---- P0-4: двухканальная регистрация/вход и коды подтверждения ----
    account: 'Телефон / Email',
    accountPlaceholder: 'Введите номер телефона или email',
    identifierRequired: 'Пожалуйста, введите номер телефона или email',
    identifierInvalid: 'Неверный формат, введите корректный номер телефона или email',
    phone: 'Номер телефона',
    phonePlaceholder: 'Введите 11-значный номер телефона',
    phoneRequired: 'Пожалуйста, введите номер телефона',
    phoneInvalid: 'Введите корректный 11-значный номер мобильного телефона материкового Китая',
    phoneTab: 'Регистрация по телефону',
    emailTab: 'Регистрация по email',
    phoneTaken: 'Этот номер телефона уже зарегистрирован',
    emailTaken: 'Этот адрес электронной почты уже зарегистрирован',
    usernameTaken: 'Это имя пользователя уже занято',
    registerPasswordPlaceholder: 'Придумайте пароль (8-32 символа, заглавные и строчные буквы, цифры)',
    passwordPolicyHint: 'Пароль должен быть длиной 8-32 символа и содержать заглавные буквы, строчные буквы и цифры',
    passwordMustContainUppercase: 'Пароль должен содержать заглавную букву',
    passwordMustContainLowercase: 'Пароль должен содержать строчную букву',
    ...
    captcha: {
      ...
      sliderHint: 'Перетащите ползунок, чтобы собрать пазл',
      textPlaceholder: 'Введите цифры',
      loading: 'Загрузка капчи...',
      loadFailed: 'Не удалось загрузить капчу',
      retry: 'Повторить',
      refresh: 'Обновить',
      passed: 'Пройдено',
      passedHint: 'Проверка на человека пройдена',
      failedHint: 'Проверка не пройдена, попробуйте ещё раз',
      required: 'Сначала пройдите проверку на человека',
    },
    verification: {
      send: 'Отправить код',
      ...
      codeMismatch: 'Неверный код, проверьте и попробуйте ещё раз',
      tooManyAttempts: 'Слишком много неудачных попыток, запросите новый код',
      invalidTarget: 'Неверный формат номера телефона или email',
      channelDisabled: 'Канал отправки кодов не настроен, обратитесь к администратору',
      resendTooFrequent: 'Отправка слишком частая, попробуйте позже',
      dailyLimit: 'Достигнут дневной лимит отправки, попробуйте завтра',
  ...
  system: {
    ...
    versionDescription: 'Версия сервиса приложения (zilan-app)',
    frontendVersionLabel: 'Версия UI',
    frontendVersionDescription: 'Версия сборки UI (zilan-ui)',
    ...
    globalSettings: {
      ...
      backup: {
        tabLabel: 'Резервное копирование',
        description:
          'Ежедневные автоматические снимки пользовательских данных: логический экспорт метаданных по пространствам, копирование файлового уровня и проверка целостности SHA-256 перед каждым восстановлением. Доступно только системным администраторам.',
        loading: 'Загрузка...',
        retry: 'Повторить',
        loadFailed: 'Не удалось загрузить записи резервных копий',
        disabledTitle: 'Подсистема резервного копирования отключена',
        disabledMessage:
          'В этом развертывании резервное копирование отключено (WEKNORA_BACKUP_ENABLED=false). После включения на этой странице появятся статус, записи и восстановление.',
        never: 'Никогда',
        lastSuccess: 'Последняя успешная копия',
        rpoCountdown: 'Следующее по расписанию',
        rpoIn: 'Примерно через {hours} ч (ежедневно в 03:00)',
        rpoOverdue: 'Окно превышено',
        retentionPolicy: 'Политика хранения',
        retentionPolicyValue: '{d} дневных / {w} недельных / {m} месячных',
        runNow: 'Создать копию',
        runSuccess: 'Резервное копирование завершено',
        runFailed: 'Ошибка резервного копирования',
        deleteConfirm: 'Удалить этот снимок и все его объекты? Действие необратимо.',
        deleteSuccess: 'Снимок удален',
        deleteFailed: 'Не удалось удалить',
        status: {
          running: 'Выполняется',
          succeeded: 'Успешно',
        ...
        trigger: {
          ...
          manual: 'Вручную',
          'pre-delete': 'Снимок перед удалением'
        },
        retention: {
          daily: 'Дневная',
          weekly: 'Недельная',
        ...
        stats: {
          workspaces: 'Пространств {n}',
          files: 'Файлов {n}'
        },
        records: {
          title: 'Записи резервных копий',
          empty: 'Записей пока нет. Нажмите «Создать копию», чтобы сделать первый снимок.',
          filterAll: 'Все статусы',
          snapshot: 'Снимок',
          statusCol: 'Статус',
          triggerCol: 'Источник',
          startedCol: 'Время начала',
          statsCol: 'Статистика',
          errorCol: 'Причина сбоя',
          actionsCol: 'Действия'
        },
        export: {
          title: 'Экспорт по пространству',
          hint:
            'Упаковывает метаданные одного пространства и все его файлы в tar.gz-архив — для переноса на другой экземпляр или комплаенса.',
          tenantId: 'ID пространства',
          download: 'Скачать архив',
          success: 'Загрузка архива началась',
        ...
        restore: {
          ...
          description:
            'Восстановление данных из снимка. Перед записью проверяется целостность SHA-256 каждого объекта; любое повреждение прерывает операцию с указанием поврежденного элемента.',
          stepScope: 'Шаг 1: область',
          scopeTenant: 'По пространству (рекомендуется — затрагивает только выбранное)',
          scopeInstance: 'Весь экземпляр (аварийное восстановление — все пространства)',
          stepTenant: 'Шаг 2: пространство и стратегия конфликтов',
          modeNew: 'Восстановить как новое пространство (имя с суффиксом -restored-, безопасно)',
          modeOverwrite: 'Перезаписать пространство (сначала очистка, затем импорт)',
          modeNote:
            '«Как новое» не изменяет существующие данные; «Перезапись» сначала удаляет текущие данные целевого пространства.',
          dryRun: 'Пробный запуск',
          dryRunTitle: 'Отчет пробного запуска',
          wouldRows: 'Строк к восстановлению',
          wouldFiles: 'Файлов к восстановлению',
          execute: 'Выполнить восстановление',
          executeConfirm: 'Запустить восстановление? Операция записывает в базу данных и файловое хранилище.',
          overwriteConfirm: 'Режим перезаписи сначала очищает данные целевого пространства. Продолжить?',
          progressTitle: 'Ход восстановления',
          rowsRestored: 'Восстановлено строк: {n}',
          filesRestored: 'Записано файлов: {n}',
          rowsSkipped: 'Пропущено конфликтующих строк: {n}',
          reindexQueued: 'Перестроек индекса в очереди: {n}',
          newTenant: 'ID нового пространства: {id}',
        ...
        jobStatus: {
          ...
          reindexing: 'Перестроение индексов',
          succeeded: 'Завершено',
          failed: 'Ошибка',
          'dry-run': 'Пробный запуск завершен'
        }
      }
    }
  },
  ...
  createChat: {
    title: 'Привет, я Zilan — ваши знания всегда под рукой',
  ...
  kbSettings: {
    ...
    parser: {
      ...
      engines: {
        ...
        weknoracloud: {
          name: 'Zilan Cloud',
          desc: 'Парсинг документов через Zilan Cloud',
        },
        markitdown: {
          name: 'MarkItDown',
  ...
  integrations: {
    ...
    api: {
      ...
      capabilityManageKbsHint: 'Позволяет управлять всем жизненным циклом баз знаний: создавать, копировать, обновлять и удалять базы знаний, а также менять их инициализацию/конфигурацию. Операции над существующими базами знаний (копирование/обновление/удаление) по-прежнему ограничены выбранной областью; создание новой базы знаний не ограничено (новая база знаний принадлежит этому пространству).',
	      ...
	      capabilityManageModelsHint: 'Управление конфигурациями моделей, учётными данными, проверками подключения и данными Zilan Cloud.',
      ...
      hmacSecretDesc: 'Тот же secret, что в Zilan; только для подписи JWT на backend — не отправляйте его в заголовке запроса.',
      ...
      signedRequestStep0:
        '# 0. Подпишите JWT на backend (HS256, aud=zilan, sub=ID пользователя, tenant_id={tenantId}, exp не более 24 ч)',
    ...
    chrome: {
      ...
      subtitle:
        'Для self-hosted Zilan: вопросы в боковой панели, клиппинг страниц и Markdown-заметки в базы знаний прямо при просмотре.',
      ...
      steps: {
        ...
        port: {
          ...
          desc: 'В Zilan Desktop задайте фиксированный порт API (например 37841) в API-информации.',
        },
        install: {
    ...
    claw: {
      title: 'Zilan Skill',
      subtitle:
        'Импорт документов и гибридный поиск (вектор + ключевые слова) через REST API Zilan — загрузки, URL, Markdown и поиск.',
      ...
      steps: {
        ...
        env: {
          ...
          desc: 'Задайте ZILAN_BASE_URL и ZILAN_API_KEY в shell или ~/.zshrc / ~/.bashrc. Пример ниже использует текущий API URL — замените API Key на фактическое значение.',
        },
        install: {
      ...
      installCtaHint: 'Установка Zilan Skill · откроется в новой вкладке',
