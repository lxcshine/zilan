...
const VIEW_MODE_KEY = 'zilan.kb.docs.viewMode';
...
onMounted(() => {
  ...
  window.addEventListener('zilan:knowledge-file-drop', handleKnowledgeFileDrop as EventListener);
  window.addEventListener('zilan:open-knowledge', handleOpenKnowledgeEvent as EventListener);
});
...
onUnmounted(() => {
  ...
  window.removeEventListener('zilan:knowledge-file-drop', handleKnowledgeFileDrop as EventListener);
  window.removeEventListener('zilan:open-knowledge', handleOpenKnowledgeEvent as EventListener);
  stopMovePoll();
  if (timeout !== null) {
