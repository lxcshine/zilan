  ...
  <div class="model-settings">
    <div class="section-header">
      ...
      <div class="builtin-models-hint" role="note">
        ...
        <a v-if="builtinModelsDocUrl" class="doc-link" :href="builtinModelsDocUrl" target="_blank"
...
// 内置模型说明文档外链：未配置则隐藏入口，避免指向外部仓库
const builtinModelsDocUrl = (import.meta.env.VITE_BUILTIN_MODELS_DOC_URL as string) || ''
