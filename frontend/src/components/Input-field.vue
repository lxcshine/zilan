...
const CHAT_FILE_DROP_EVENT = 'zilan:chat-file-drop';
...
const LAST_CHAT_MODEL_KEY = 'zilan_last_chat_model_id'
...
.rich-input-container {
  ...
  &:focus-within {
    border-color: var(--td-brand-color, #333333);
    box-shadow: 0 1px 2px rgba(0, 0, 0, 0.04), 0 6px 20px rgba(0, 0, 0, 0.07);
  }
}
...
.selected-tags-inline {
  ...
  /* 与 .rich-input-container 内缘上边圆角一致（16px - 1px 边框） */
}
...
.mention-chip--faq .mention-chip__icon-wrap {
  color: var(--zilan-faq-color, #0052d9);
}
