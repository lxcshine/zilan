...
export const GLOBAL_USER_GUIDE_KEY = 'zilan:new-user-guide-done:v1'
export const OPEN_NEW_USER_GUIDE_EVENT = 'zilan:open-new-user-guide'

export function openNewUserGuide() {
  window.dispatchEvent(new CustomEvent(OPEN_NEW_USER_GUIDE_EVENT))
}

export const KB_EDITOR_FOCUS_SECTION_EVENT = 'zilan:kb-editor-focus-section'
export const AGENT_EDITOR_FOCUS_SECTION_EVENT = 'zilan:agent-editor-focus-section'
...
export const CONTEXTUAL_GUIDE_TOURS: Record<ContextualGuideTourId, ContextualGuideTourConfig> = {
  kbList: {
    storageKey: 'zilan:contextual-guide-kb-list:v2',
  ...
  kbCreate: {
    storageKey: 'zilan:contextual-guide-kb-create:v3',
  ...
  tenantModels: {
    storageKey: 'zilan:contextual-guide-tenant-models:v1',
    stepI18nPrefix: 'contextualGuide.tenantModels.steps',
    openDelayMs: 500,
    steps: [],
  },
  kbDetail: {
    storageKey: 'zilan:contextual-guide-kb-detail:v1',
  ...
  chat: {
    storageKey: 'zilan:contextual-guide-chat:v1',
  ...
  agentList: {
    storageKey: 'zilan:contextual-guide-agent-list:v1',
  ...
  agentCreate: {
    storageKey: 'zilan:contextual-guide-agent-create:v1',
