...
type updateMyPreferencesRequest struct {
	...
	// MemoryEnabled toggles the long-term memory feature (extraction after
	// each turn + recall injection into the system prompt). Nil = untouched;
	// absent preference defaults to enabled.
