...
const (
	...
	// ResourceTypeSession marks a chat session as favorited. Beyond the UI
	// star, a session favorite doubles as the explicit "high-value" signal
	// for knowledge precipitation (4.4): favorited sessions get distilled
	// into knowledge-base documents automatically.
...
func IsValidFavoriteResourceType(t string) bool {
	switch t {
	case ResourceTypeKB, ResourceTypeAgent, ResourceTypeSession:
		return true
	default:
		return false
	}
