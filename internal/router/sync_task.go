...
func RegisterSyncHandlers(params SyncTaskParams) {
	...
	params.Executor.RegisterHandler(types.TypeMemoryExtract, params.MemoryService.ProcessMemoryExtract)
	params.Executor.RegisterHandler(types.TypeSessionPrecipitate, params.PrecipitationService.ProcessSessionPrecipitate)
	params.Executor.RegisterHandler(types.TypeGraphCommunityBuild, params.GraphCommunity.ProcessGraphCommunityBuild)
