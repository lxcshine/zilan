...
// retrievalConfigFromContext extracts the tenant's RetrievalConfig from the
// context. Returns nil when no tenant info is present.
func retrievalConfigFromContext(ctx context.Context) *types.RetrievalConfig {
